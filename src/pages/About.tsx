  ...
  return (
    <div className="min-h-screen py-24 px-6">
      <div className="max-w-7xl mx-auto">
          ...
          {deepDives.map((feature, index) => (
            ...
            >
              ...
              <div className="flex-1 max-w-md">
                <div className="card-glow aspect-square rounded-xl p-8 flex items-center justify-center">
        ...
        {/* Values statement */}
        <div className="text-center bg-gradient-card rounded-2xl p-12 mb-16">
          <h2 className="text-3xl font-bold mb-6">Built for Writers Who Value Growth</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-12">
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground">Automated publishing</p>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-gradient mb-2">99%</div>
              <p className="text-muted-foreground">Quality maintained</p>
            </div>
          </div>
        </div>
        ...
        <div className="text-center">
          ...
          <p className="text-muted-foreground mt-4">No credit card required • Setup in 5 minutes</p>
        </div>
      </div>
    </div>
  );
